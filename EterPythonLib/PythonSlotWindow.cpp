...
void CSlotWindow::ActivateSlot(DWORD dwIndex)
{
	...
	if (!m_pSlotActiveEffect1 || !m_pSlotActiveEffect2 || !m_pSlotActiveEffect3)
	{
		__CreateSlotEnableEffect1();
		__CreateSlotEnableEffect2();
		__CreateSlotEnableEffect3();
	}
}
...
void CSlotWindow::OnUpdate()
{
	...
	if (m_pSlotActiveEffect1)
		m_pSlotActiveEffect1->Update();

	if (m_pSlotActiveEffect2)
		m_pSlotActiveEffect2->Update();

	if (m_pSlotActiveEffect3)
		m_pSlotActiveEffect3->Update();
}
...
void CSlotWindow::OnRender()
{
	...
	for (itor = m_SlotList.begin(); itor != m_SlotList.end(); ++itor)
	{
		...
		if (rSlot.bActive)
		{
			...
			if (rSlot.byyPlacedItemSize >= 3)
			{
				if (m_pSlotActiveEffect3)
				{
					m_pSlotActiveEffect3->SetPosition(ix, iy);
					m_pSlotActiveEffect3->Render();
				}
			}
			else if (rSlot.byyPlacedItemSize >= 2)
			{
				if (m_pSlotActiveEffect2)
				{
					m_pSlotActiveEffect2->SetPosition(ix, iy);
					m_pSlotActiveEffect2->Render();
				}
			}
			else
			{
				if (m_pSlotActiveEffect1)
				{
					m_pSlotActiveEffect1->SetPosition(ix, iy);
					m_pSlotActiveEffect1->Render();
				}
			}
		}
	}
...
void CSlotWindow::__CreateSlotEnableEffect1()
{
	__DestroySlotEnableEffect();

	m_pSlotActiveEffect1 = new CAniImageBox(NULL);
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/00.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/01.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/02.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/03.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/04.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/05.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/06.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/07.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/08.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/09.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/10.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/11.sub");
	m_pSlotActiveEffect1->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot1/12.sub");
	m_pSlotActiveEffect1->SetRenderingMode(CGraphicExpandedImageInstance::RENDERING_MODE_SCREEN);
	m_pSlotActiveEffect1->Show();
}

void CSlotWindow::__CreateSlotEnableEffect2()
{
	m_pSlotActiveEffect2 = new CAniImageBox(NULL);
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/00.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/01.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/02.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/03.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/04.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/05.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/06.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/07.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/08.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/09.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/10.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/11.sub");
	m_pSlotActiveEffect2->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/12.sub");
	m_pSlotActiveEffect2->SetRenderingMode(CGraphicExpandedImageInstance::RENDERING_MODE_SCREEN);
	m_pSlotActiveEffect2->Show();
}

void CSlotWindow::__CreateSlotEnableEffect3()
{
	m_pSlotActiveEffect3 = new CAniImageBox(NULL);
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/00.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/01.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/02.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/03.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/04.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/05.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/06.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/07.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/08.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/09.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/10.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/11.sub");
	m_pSlotActiveEffect3->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot3/12.sub");
	m_pSlotActiveEffect3->SetRenderingMode(CGraphicExpandedImageInstance::RENDERING_MODE_SCREEN);
	m_pSlotActiveEffect3->Show();
}
...
void CSlotWindow::__DestroySlotEnableEffect()
{
	if (m_pSlotActiveEffect1)
	{
		delete m_pSlotActiveEffect1;
		m_pSlotActiveEffect1 = NULL;
	}

	if (m_pSlotActiveEffect2)
	{
		delete m_pSlotActiveEffect2;
		m_pSlotActiveEffect2 = NULL;
	}

	if (m_pSlotActiveEffect3)
	{
		delete m_pSlotActiveEffect3;
		m_pSlotActiveEffect3 = NULL;
	}
}
