...
namespace UI 
{
	...
	class CSlotWindow : public CWindow
	{
		...
		protected:
			...
			void __CreateSlotEnableEffect1();
			void __CreateSlotEnableEffect2();
			void __CreateSlotEnableEffect3();
		...
		protected:
			...
			CAniImageBox* m_pSlotActiveEffect1;
			CAniImageBox* m_pSlotActiveEffect2;
			CAniImageBox* m_pSlotActiveEffect3;
