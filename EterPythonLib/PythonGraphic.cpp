...
void CPythonGraphic::SetMobPreviewLight()
{
	...
	Material.Ambient = D3DXCOLOR(0.45f, 0.45f, 0.45f, 1.0f);
	Material.Diffuse = D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f);
	Material.Emissive = D3DXCOLOR(0.05f, 0.05f, 0.05f, 1.0f);
	...
	Light.Direction = D3DXVECTOR3(0.3f, 0.6f, -1.0f);
	...
	Light.Ambient.r = 0.35f;
	Light.Ambient.g = 0.35f;
	...
	Light.Type = D3DLIGHT_POINT;
	Light.Position = D3DXVECTOR3(-250.0f, -300.0f, 350.0f);
	Light.Range = 1500.0f;
	...
	Light.Diffuse.r = 0.45f;
	Light.Diffuse.g = 0.45f;
