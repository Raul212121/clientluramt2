...
const char* CPythonBackground::GetMapName()
{
	...
	if (c_rstrMapFileName == "metin2_map_a1")
		return "Yongan";
	else if (c_rstrMapFileName == "metin2_map_a2")
		return "Valea Seungryoung";
	else if (c_rstrMapFileName == "metin2_map_a3")
		return "Yayang";
	else if (c_rstrMapFileName == "metin2_map_b1")
		return "Joan";
	else if (c_rstrMapFileName == "metin2_map_b3")
		return "Bokjung";
	else if (c_rstrMapFileName == "metin2_map_c1")
		return "Pyungmoo";
	else if (c_rstrMapFileName == "metin2_map_c3")
		return "Bakra";
	else if (c_rstrMapFileName == "metin2_map_n_desert_01")
		return "Desertul Yongbi";
	else if (c_rstrMapFileName == "metin2_map_n_snow_01")
		return "Muntele Sohan";
	else if (c_rstrMapFileName == "metin2_map_n_flame_01")
		return "Doyyumhwan";
	else if (c_rstrMapFileName == "metin2_map_milgyo")
		return "Templul Hwang";
	else if (c_rstrMapFileName == "metin2_map_deviltower1")
		return "Turnul Demonilor";
	else if (c_rstrMapFileName == "metin2_map_trent")
		return "Lungsam";
	else if (c_rstrMapFileName == "metin2_map_trent02")
		return "Padurea Rosie";
	else if (c_rstrMapFileName == "metin2_map_spiderdungeon")
		return "Temnita Paianjenilor";
	else if (c_rstrMapFileName == "metin2_map_spiderdungeon_02")
		return "Temnita Paianjenilor 2";
	else if (c_rstrMapFileName == "metin2_map_spiderdungeon_03")
		return "Temnita Paianjenilor 3";
	else if (c_rstrMapFileName == "metin2_map_skipia_dungeon_01")
		return "Grota Exiliului";
	else if (c_rstrMapFileName == "metin2_map_skipia_dungeon_02")
		return "V4";
	else if (c_rstrMapFileName == "Metin2_map_CapeDragonHead")
		return "Cape Dragon Head";
	else if (c_rstrMapFileName == "metin2_map_Mt_Thunder")
		return "Thunder";
	else if (c_rstrMapFileName == "metin2_map_dawnmistwood")
		return "Dawnmistwood";
	else if (c_rstrMapFileName == "metin2_map_BayBlackSand")
		return "Bay Black Sand";
	else if (c_rstrMapFileName == "season1/metin2_map_oxevent")
		return "OX";
	else
		return "-";
}
