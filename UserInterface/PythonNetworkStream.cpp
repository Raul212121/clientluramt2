...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_GC_TELEPORT, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCTeleport), STATIC_SIZE_PACKET));
			Set(HEADER_GC_RECEIVE_RANK, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketCGReceiveRank), STATIC_SIZE_PACKET));
#endif
